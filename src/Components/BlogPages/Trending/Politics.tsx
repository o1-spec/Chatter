...
function Politics() {
  ...
  const politicBlog: TrendingInterface[] = [];
  totalBlogs.map((blog) => {
    if (blog.category === "Politics") {
      politicBlog.push(blog);
    } else {
      return;
    }
  });
      ...
      <div className="md:max-w-[80%] mx-auto my-0 py-8 px-3 md:px-0">
        <div className="flex justify-between items-center pb-6">
          <div className="flex flex-col gap-4">
            <h2 className="text-3xl font-semibold">Politics</h2>
            <span className="text-[16px] pb-4 sm:pb-0">
              Explore different politics related content you’d love
            </span>
          </div>
        </div>
        <div className="border border-borderIcon pt-5 rounded-md">
          <div className="py-5 pt-1">
            {politicBlog.map((blog) => (
              <div
              ...
              >
                <div className="md:w-[450px] lg:w-[600px] w-fit my-0 mx-auto">
                  <div className="flex flex-col gap-3">
                    ...
                    <p className="text-[15px] md:text-[16px] pr-3 sm:pr-6">

...
function Feed() {
  return (
    <div className="m-7 border border-borderIcon h-full w-[1000px]">
      <div className="max-w-[80%] mx-auto my-0 py-8">
        <div className="flex justify-between items-center pb-6">
          ...
          <div>
            <button className="flex gap-2 items-center text-textWhite text-[15px] border bg-textBlue px-6 py-2 rounded-lg transition hover:bg-textWhite hover:text-textBlue border-textBlue duration-300">
